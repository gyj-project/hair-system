...
import cn.bzu.hair.message.utils.HttpDeleteUtil;
import cn.bzu.hair.message.utils.RequestEncoder;
...
/**
 * 这个类实现了ISender，包含了在发送之前处理发生的事件的常用方法 创建了一个签名并构建请求数据
 * 
 * @author submail
 *
 */
public class Sender implements ISender {
	...
	/**
	 * 当 {@link AppConfig#setSignType(String)} 不正常时,创建 一个签名类型
	 * 
	 * @param data
	 *            请求数据
	 * @return signature
